...
class Gestion_boutiquier extends StatefulWidget {
  const Gestion_boutiquier({super.key});

  @override
  State<Gestion_boutiquier> createState() => _Gestion_boutiquierState();
}

class _Gestion_boutiquierState extends State<Gestion_boutiquier> {
  @override
